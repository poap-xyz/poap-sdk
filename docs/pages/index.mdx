...
Before getting started, there is some POAP terminology that may be worth familiarizing yourself with, as these will be referenced frequently throughout the documentation. Go ahead and explore [the POAP glossary](https://help.poap.xyz/hc/en-us/articles/18607766574989-POAP-Glossary) to get up to speed on the vocabulary.
